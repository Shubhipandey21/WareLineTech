...
const MethodologySection = ({ heading, description, cards }) => {
  return (
    <section className="h-screen flex flex-col justify-center items-center bg-gray-100">
      ...
      <div className="mt-10 grid gap-10 md:grid-cols-3 w-full px-6 max-w-7xl">
        {cards.map((card, index) => (
          <div
            key={index}
            className="bg-gradient-to-b from-green-100  to-white-100 shadow-lg rounded-lg p-8 text-center text-black flex flex-col justify-between"
            style={{ height: '600px' }}
          >
