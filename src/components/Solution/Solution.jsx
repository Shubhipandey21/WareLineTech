  ...
  const solutions = [
    {
      icon: (
        <svg viewBox="0 0 24 24" className="w-16 h-16 mx-auto mb-6">
          <circle cx="12" cy="12" r="10" className="stroke-purple-400 fill-none"/>
    ...
    },
    {
      icon: (
        <svg viewBox="0 0 24 24" className="w-16 h-16 mx-auto mb-6">
          <circle cx="12" cy="12" r="10" className="stroke-purple-400 fill-none"/>
          <path d="M8 14s1.5 2 4 2 4-2 4-2" className="stroke-purple-400 stroke-2"/>
    ...
    <div className="max-w-7xl mx-auto px-4 py-16">
      <div className="text-center mb-16">
        ...
        <h2 className="text-3xl font-bold mb-4">
          Choose your path to <span className="text-gray-900">digital success</span>
        </h2>
        <p className="text-xl text-gray-600">
          Whether ideating, scaling, or optimizing, we've got you covered with our expert solutions.
        </p>
      </div>
