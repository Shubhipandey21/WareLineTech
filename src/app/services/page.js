    ...
    const expertiseData = [
        {
            ...
            description: 'Create innovative and user-friendly mobile applications for iOS and Android.',
        ...
        },
        {
            ...
            description: 'Design and develop responsive and high-performance web applications.',
        ...
        },
        {
            id: 3,
            title: 'Cloud',
            description: 'Build custom solutions for tablet devices tailored to your needs.',
        ...
        },
        {
            ...
            bgImage: 'https://images.pexels.com/photos/28674408/pexels-photo-28674408/free-photo-of-historic-clock-tower-in-black-and-white.jpeg?auto=compress&cs=tinysrgb&w=600&lazy=load', // Replace with your image URL
            icon: Smartphone,
        ...
        },
        {
            id: 5,
            title: 'UI/UX Design',
            description: 'Craft intuitive and visually appealing interfaces for better engagement.',
            bgImage: 'https://images.pexels.com/photos/29714309/pexels-photo-29714309/free-photo-of-majestic-iguazu-falls-in-lush-argentinian-jungle.jpeg?auto=compress&cs=tinysrgb&w=600&lazy=load', // Replace with your image URL
            icon: Monitor,
            iconBg: 'bg-pink-100',
        },
        {
            ...
            description: 'Enable businesses to transform digitally with innovative solutions.',
            bgImage: 'https://images.pexels.com/photos/29714309/pexels-photo-29714309/free-photo-of-majestic-iguazu-falls-in-lush-argentinian-jungle.jpeg?auto=compress&cs=tinysrgb&w=600&lazy=load', // Replace with your image URL
            icon: Tablet,
        ...
        sections: [
            {
                ...
                frameworks: [
                    ...
                    { name: 'Angular', icon: 'https://cdn-icons-png.flaticon.com/128/15484/15484402.png' }
                ]
            },
            {
                categoryId: 2, // Backend
                coreTechnologies: [
                    { name: 'Node.js', icon: 'https://cdn-icons-png.flaticon.com/128/15380/15380914.png' },
                ...
                frameworks: [
                    ...
                    { name: 'Django', icon: 'https://icon.icepanel.io/Technology/png-shadow-512/Django.png' },
                    { name: 'Spring Boot', icon: 'https://icon.icepanel.io/Technology/svg/Spring.svg' }
                ]
            },
            {
                categoryId: 3, // Database
                coreTechnologies: [
                    { name: 'MySQL', icon: 'https://cdn-icons-png.flaticon.com/128/1199/1199128.png' },
                    { name: 'PostgreSQL', icon: 'https://cdn-icons-png.flaticon.com/128/10464/10464247.png' },
                ...
                frameworks: [
                    ...
                    { name: 'Sequelize', icon: 'https://icon.icepanel.io/Technology/svg/Sequelize.svg' }
                ]
            },
            {
                categoryId: 4, // Cloud Storage
                coreTechnologies: [
                    { name: 'AWS', icon: 'https://icon.icepanel.io/Technology/png-shadow-512/AWS.png' },
                    { name: 'Google Cloud Storage', icon: 'https://icon.icepanel.io/Technology/svg/Google-Cloud.svg' }
                ],
                frameworks: [
